  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-b from-blue-300 to-blue-100">
      <div className="mb-4 text-center">
        <h1 className="text-3xl font-bold text-gray-800 mb-2">Google Dinosaur Game</h1>
        {!isGameStarted ? (
          <p className="text-lg text-gray-600">Press SPACEBAR to start</p>
        ) : (
          <p className="text-lg text-gray-600">Press SPACEBAR to jump, avoid cactus obstacles!</p>
        )}
      </div>
      ...
      <div className="mt-4 text-center">
        <p className="text-sm text-gray-500">
          Simple dinosaur running game - jump to avoid cactus obstacles!
        </p>
      </div>
    </div>
  );
